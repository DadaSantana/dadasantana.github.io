...
function editElement(element) {
    ...
    function upToEdit(i,t,r) {
        ...
        selectedImg = document.querySelector(".add-img").style.backgroundImage = `url('${i}')`;
        document.querySelector(".add-img").style.backgroundSize = 'cover';
        document.querySelector(".add-img").style.backgroundPosition = 'center';
    }
    upToEdit();
    selectedImg = getURLToSelectedImg();
}

function getURLToSelectedImg(){
    selectedImg = selectedImg.slice(5);
    selectedImg = selectedImg.slice(0,46)
}
